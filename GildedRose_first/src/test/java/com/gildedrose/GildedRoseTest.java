...
class GildedRoseTest {
    ...
    void sulfurasZeroSellin() {
        Item[] items = {new Item("Sulfuras, Hand of Ragnaros", 0, 80, false, false, true) };
        GildedRose app = new GildedRose(items);
        app.updateQuality();
    ...
    void sulfurasNegativeSellin() {
        Item[] items = {new Item("Sulfuras, Hand of Ragnaros", -1, 80, false, false, true) };
        GildedRose app = new GildedRose(items);
        app.updateQuality();
        assertEquals(80, app.items[0].quality);
    }
    ...
    void conjuredNegativeSellin() {
        Item[] items = {new Item("Conjured Mana Cake", -1, 6, true, true, false) };
        GildedRose app = new GildedRose(items);
        app.updateQuality();
        assertEquals(2, app.items[0].quality);
    }
    ...
    void conjuredPositiveSellin() {
        Item[] items = {new Item("Conjured Mana Cake", 3, 6, true, true, false) };
        GildedRose app = new GildedRose(items);
        app.updateQuality();
    ...
    void backstagePassesSellinFiveorLessMaxTest() {
        Item[] items = {new Item("Backstage passes to a TAFKAL80ETC concert", 3, 49, false, false, false) };
        GildedRose app = new GildedRose(items);
        app.updateQuality();
    ...
    void backstagePassesSellinBetweenTenAndSixMaxTest() {
        Item[] items = {new Item("Backstage passes to a TAFKAL80ETC concert", 7, 49, false, false, false) };
        GildedRose app = new GildedRose(items);
        app.updateQuality();
        assertEquals(50, app.items[0].quality);
    }
    ...
    void backstagePassesNegativeSellin() {
        Item[] items = {new Item("Backstage passes to a TAFKAL80ETC concert", -5, 49, false, false, false) };
        GildedRose app = new GildedRose(items);
        app.updateQuality();
        assertEquals(0, app.items[0].quality);
    }
    ...
    void backstagePassesSellinFiveorLess() {
        Item[] items = {new Item("Backstage passes to a TAFKAL80ETC concert", 3, 40, false, false, false) };
        GildedRose app = new GildedRose(items);
        app.updateQuality();
    ...
    void backstagePassesSellinBetweenTenAndSix() {
        Item[] items = {new Item("Backstage passes to a TAFKAL80ETC concert", 7, 40, false, false, false)};
        GildedRose app = new GildedRose(items);
        app.updateQuality();
